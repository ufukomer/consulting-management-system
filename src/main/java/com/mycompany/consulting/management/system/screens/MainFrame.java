...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        tableModel2 = new DefaultTableModel(new Object[]{"id", "Project Name", "Sector", "Min Per.", "Max Par.",
                "Project Manager Number", "Analyst Number", "Designer Number", "Developer Number", "Tester Number",
                "Started Date"}, 0);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ProjectService projectService = new ProjectService();
            boolean doIt = projectService.projectRoleOperation(Integer.parseInt(jTable1.getModel()
            ...
            if (doIt) {
                ...
                JOptionPane.showMessageDialog(rootPane, "There is no available personnel for selected project.");
            }
